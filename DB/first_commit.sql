...
-- Dumping data for table hmvc.nng_chat: ~2 rows (approximately)
/*!40000 ALTER TABLE `nng_chat` DISABLE KEYS */;
INSERT INTO `nng_chat` (`id`, `usename`, `teks`, `waktu`, `status`) VALUES
	(1, 'ATAKU', 'Selamat datang di aplikasi offline Aset Desa', '2017-05-16 11:49:39', 1),
	(2, 'ATAKU', 'Kerja Kerja Kerja....', '2017-05-16 13:39:15', 1);
...
-- Dumping data for table hmvc.nng_todo: ~0 rows (approximately)
