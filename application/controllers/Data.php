...
class Data extends BaseController {
	...
	public function banner_samping()
	{
			$crud = new grocery_CRUD();

			$crud->set_theme('flexigrid');
			$crud->set_table('nng_banner_samping');
			$crud->set_subject('Banner Samping');
	...
	public function chat()
	{
			...
			$crud->set_theme('flexigrid');
			$crud->set_table('nng_chat');
			$crud->set_subject('Chat');
			$crud->unset_add();
